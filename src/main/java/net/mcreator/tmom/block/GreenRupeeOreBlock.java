...
public class GreenRupeeOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:green_rupee_ore")
	public static final Block block = null;

	public GreenRupeeOreBlock(TmimModElements instance) {
		super(instance, 297);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("green_rupee_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GreenRupeeItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:green_rupee_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("green_rupee_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:green_rupee_ore"), configuredFeature);
		}
	}
