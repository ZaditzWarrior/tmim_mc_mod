...
import net.mcreator.tmom.item.RubyItem;
...
public class RubyOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:ruby_ore")
	public static final Block block = null;

	public RubyOreBlock(TmimModElements instance) {
		super(instance, 51);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:ruby_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:ruby_ore"), configuredFeature);
		}
	}
