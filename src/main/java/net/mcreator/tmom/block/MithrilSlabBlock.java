...
public class MithrilSlabBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:mithril_slab")
	public static final Block block = null;

	public MithrilSlabBlock(TmimModElements instance) {
		super(instance, 504);
	}
