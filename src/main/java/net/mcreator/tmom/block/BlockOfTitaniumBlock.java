...
public class BlockOfTitaniumBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_titanium")
	public static final Block block = null;

	public BlockOfTitaniumBlock(TmimModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_titanium");
		}
