...
import net.mcreator.tmom.item.AmethystShardItem;
...
public class AmethystCrystalsBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:amethyst_crystals")
	public static final Block block = null;

	public AmethystCrystalsBlock(TmimModElements instance) {
		super(instance, 137);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("amethyst_crystals"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:amethyst_crystals"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("amethyst_crystals");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AmethystShardItem.block, (int) (4)));
		}
