...
public class UraniumGlassBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:uranium_glass")
	public static final Block block = null;

	public UraniumGlassBlock(TmimModElements instance) {
		super(instance, 170);
	}
