...
public class MagnesiumOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:magnesium_ore")
	public static final Block block = null;

	public MagnesiumOreBlock(TmimModElements instance) {
		super(instance, 253);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:magnesium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:magnesium_ore"), configuredFeature);
		}
	}
