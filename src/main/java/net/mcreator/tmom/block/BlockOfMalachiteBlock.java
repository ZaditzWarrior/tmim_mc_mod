...
public class BlockOfMalachiteBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_malachite")
	public static final Block block = null;

	public BlockOfMalachiteBlock(TmimModElements instance) {
		super(instance, 214);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_malachite");
		}
