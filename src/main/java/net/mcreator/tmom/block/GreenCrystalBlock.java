...
import net.mcreator.tmom.item.GreenCrysalShardItem;
...
public class GreenCrystalBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:green_crystal")
	public static final Block block = null;

	public GreenCrystalBlock(TmimModElements instance) {
		super(instance, 91);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:green_crystal"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GreenCrysalShardItem.block, (int) (2)));
		}
