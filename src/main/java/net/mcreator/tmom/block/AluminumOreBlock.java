...
public class AluminumOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:aluminum_ore")
	public static final Block block = null;

	public AluminumOreBlock(TmimModElements instance) {
		super(instance, 138);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:aluminum_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("aluminum_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:aluminum_ore"), configuredFeature);
		}
	}
