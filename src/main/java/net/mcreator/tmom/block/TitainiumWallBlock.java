...
public class TitainiumWallBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:titainium_wall")
	public static final Block block = null;

	public TitainiumWallBlock(TmimModElements instance) {
		super(instance, 526);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(6f, 15f).setLightLevel(s -> 0).notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("titainium_wall");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A wall made from Titainium"));
		}
