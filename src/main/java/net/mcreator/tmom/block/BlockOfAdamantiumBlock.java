...
public class BlockOfAdamantiumBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_adamantium")
	public static final Block block = null;

	public BlockOfAdamantiumBlock(TmimModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_adamantium");
		}
