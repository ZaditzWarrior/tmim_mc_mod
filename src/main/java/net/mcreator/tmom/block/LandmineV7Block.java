...
import net.mcreator.tmom.procedures.Explosion_X1000Procedure;
...
public class LandmineV7Block extends TmimModElements.ModElement {
	@ObjectHolder("tmim:landmine_v_7")
	public static final Block block = null;

	public LandmineV7Block(TmimModElements instance) {
		super(instance, 672);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Explodes when stepped on"));
			list.add(new StringTextComponent("[Requires More than 6GB RAM]"));
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Explosion_X1000Procedure.executeProcedure(Stream
