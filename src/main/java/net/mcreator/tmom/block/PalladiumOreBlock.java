...
public class PalladiumOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:palladium_ore")
	public static final Block block = null;

	public PalladiumOreBlock(TmimModElements instance) {
		super(instance, 157);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:palladium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:palladium_ore"), configuredFeature);
		}
	}
