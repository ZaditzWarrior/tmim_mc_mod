...
public class AdamantiumFrameBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:adamantium_frame")
	public static final Block block = null;

	public AdamantiumFrameBlock(TmimModElements instance) {
		super(instance, 522);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("adamantium_frame");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A frame made from Adamantium"));
		}
