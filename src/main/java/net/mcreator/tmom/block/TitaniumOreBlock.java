...
public class TitaniumOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:titanium_ore")
	public static final Block block = null;

	public TitaniumOreBlock(TmimModElements instance) {
		super(instance, 40);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:titanium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:titanium_ore"), configuredFeature);
		}
	}
