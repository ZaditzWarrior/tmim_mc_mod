...
public class FrameBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:frame")
	public static final Block block = null;

	public FrameBlock(TmimModElements instance) {
		super(instance, 518);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Mainly Used to make scafflding"));
		}
