...
public class TopazOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:topaz_ore")
	public static final Block block = null;

	public TopazOreBlock(TmimModElements instance) {
		super(instance, 148);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:topaz_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:topaz_ore"), configuredFeature);
		}
	}
