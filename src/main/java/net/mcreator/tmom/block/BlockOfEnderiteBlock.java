...
public class BlockOfEnderiteBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_enderite")
	public static final Block block = null;

	public BlockOfEnderiteBlock(TmimModElements instance) {
		super(instance, 209);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_enderite");
		}
