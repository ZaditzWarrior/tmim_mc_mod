...
import net.mcreator.tmom.procedures.Explode_x25Procedure;
...
public class LandmineV3Block extends TmimModElements.ModElement {
	@ObjectHolder("tmim:landmine_v_3")
	public static final Block block = null;

	public LandmineV3Block(TmimModElements instance) {
		super(instance, 660);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Explode_x25Procedure.executeProcedure(Stream
