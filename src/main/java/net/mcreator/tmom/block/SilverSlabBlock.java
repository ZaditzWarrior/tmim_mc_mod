...
public class SilverSlabBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:silver_slab")
	public static final Block block = null;

	public SilverSlabBlock(TmimModElements instance) {
		super(instance, 500);
	}
