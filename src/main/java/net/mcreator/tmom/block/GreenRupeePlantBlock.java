...
public class GreenRupeePlantBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:green_rupee_plant")
	public static final Block block = null;

	public GreenRupeePlantBlock(TmimModElements instance) {
		super(instance, 318);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("green_rupee_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:green_rupee_plant"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("green_rupee_plant");
		}
