...
public class BlockOfTineBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_tine")
	public static final Block block = null;

	public BlockOfTineBlock(TmimModElements instance) {
		super(instance, 147);
	}
