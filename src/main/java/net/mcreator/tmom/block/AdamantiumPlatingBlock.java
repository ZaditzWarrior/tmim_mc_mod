...
public class AdamantiumPlatingBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:adamantium_plating")
	public static final Block block = null;

	public AdamantiumPlatingBlock(TmimModElements instance) {
		super(instance, 402);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("adamantium_plating");
		}
