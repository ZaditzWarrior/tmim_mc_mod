...
public class BlockofSinconiumBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:blockof_sinconium")
	public static final Block block = null;

	public BlockofSinconiumBlock(TmimModElements instance) {
		super(instance, 288);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockof_sinconium");
		}
