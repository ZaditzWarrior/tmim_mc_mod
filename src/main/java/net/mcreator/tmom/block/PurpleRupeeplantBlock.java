...
public class PurpleRupeeplantBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:purple_rupeeplant")
	public static final Block block = null;

	public PurpleRupeeplantBlock(TmimModElements instance) {
		super(instance, 319);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("purple_rupeeplant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:purple_rupeeplant"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("purple_rupeeplant");
		}
		...
		public boolean isValidPosition(BlockState blockstate, IWorldReader worldIn, BlockPos pos) {
			...
			return ground == this || (ground == Blocks.GRASS_BLOCK || ground == Blocks.DIRT
