...
public class CobaltStairsBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:cobalt_stairs")
	public static final Block block = null;

	public CobaltStairsBlock(TmimModElements instance) {
		super(instance, 512);
	}
