...
public class IrradiatedDirtBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:irradiated_dirt")
	public static final Block block = null;

	public IrradiatedDirtBlock(TmimModElements instance) {
		super(instance, 201);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("irradiated_dirt");
		}
