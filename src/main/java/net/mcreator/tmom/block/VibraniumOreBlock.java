...
public class VibraniumOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:vibranium_ore")
	public static final Block block = null;

	public VibraniumOreBlock(TmimModElements instance) {
		super(instance, 119);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:vibranium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:vibranium_ore"), configuredFeature);
		}
	}
