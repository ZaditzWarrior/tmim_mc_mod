...
import net.mcreator.tmom.procedures.Explode_standardProcedure;
...
public class LandmineBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:landmine")
	public static final Block block = null;

	public LandmineBlock(TmimModElements instance) {
		super(instance, 654);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Explode_standardProcedure.executeProcedure(Stream
