...
public class SarconiumStairsBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:sarconium_stairs")
	public static final Block block = null;

	public SarconiumStairsBlock(TmimModElements instance) {
		super(instance, 510);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("sarconium_stairs");
		}
