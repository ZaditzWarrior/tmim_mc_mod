...
public class EnergonCrystalBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:energon_crystal")
	public static final Block block = null;

	public EnergonCrystalBlock(TmimModElements instance) {
		super(instance, 83);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("energon_crystal"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:energon_crystal"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("energon_crystal");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(EnergonShardItem.block, (int) (2)));
		}
