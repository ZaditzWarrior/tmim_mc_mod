...
public class AdamantiumOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:adamantium_ore")
	public static final Block block = null;

	public AdamantiumOreBlock(TmimModElements instance) {
		super(instance, 105);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("adamantium_ore");
		}
