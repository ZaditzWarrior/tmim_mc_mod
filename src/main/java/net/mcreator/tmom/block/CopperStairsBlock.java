...
public class CopperStairsBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:copper_stairs")
	public static final Block block = null;

	public CopperStairsBlock(TmimModElements instance) {
		super(instance, 508);
	}
