...
import net.mcreator.tmom.procedures.Explosion_X50Procedure;
...
public class LandmineV4Block extends TmimModElements.ModElement {
	@ObjectHolder("tmim:landmine_v_4")
	public static final Block block = null;

	public LandmineV4Block(TmimModElements instance) {
		super(instance, 663);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Explosion_X50Procedure.executeProcedure(Stream
