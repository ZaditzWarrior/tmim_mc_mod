...
public class DarkEnergonCrystalsBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:dark_energon_crystals")
	public static final Block block = null;

	public DarkEnergonCrystalsBlock(TmimModElements instance) {
		super(instance, 86);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("dark_energon_crystals"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:dark_energon_crystals"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("dark_energon_crystals");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DarkEnergonShardItem.block, (int) (2)));
		}
