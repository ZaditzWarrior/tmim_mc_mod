...
public class BlockOfSteelBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_steel")
	public static final Block block = null;

	public BlockOfSteelBlock(TmimModElements instance) {
		super(instance, 204);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(4f, 40f).setLightLevel(s -> 0).harvestLevel(2)
