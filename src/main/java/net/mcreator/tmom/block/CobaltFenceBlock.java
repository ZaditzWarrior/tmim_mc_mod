...
public class CobaltFenceBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:cobalt_fence")
	public static final Block block = null;

	public CobaltFenceBlock(TmimModElements instance) {
		super(instance, 576);
	}
	...
	public static class CustomBlock extends FenceBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A fence made from cobalt"));
		}
