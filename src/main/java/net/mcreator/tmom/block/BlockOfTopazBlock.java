...
public class BlockOfTopazBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_topaz")
	public static final Block block = null;

	public BlockOfTopazBlock(TmimModElements instance) {
		super(instance, 151);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_topaz");
		}
