...
public class FluidContainerBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:fluid_container")
	public static final Block block = null;
	@ObjectHolder("tmim:fluid_container")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public FluidContainerBlock(TmimModElements instance) {
		super(instance, 132);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("fluid_container"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("fluid_container");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Fluid Container");
		}
		...
		private final FluidTank fluidTank = new FluidTank(500000) {
			@Override
