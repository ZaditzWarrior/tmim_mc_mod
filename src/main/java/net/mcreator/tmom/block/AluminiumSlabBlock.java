...
public class AluminiumSlabBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:aluminium_slab")
	public static final Block block = null;

	public AluminiumSlabBlock(TmimModElements instance) {
		super(instance, 506);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("aluminium_slab");
		}
