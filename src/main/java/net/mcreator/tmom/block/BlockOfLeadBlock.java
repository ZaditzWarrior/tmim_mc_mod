...
public class BlockOfLeadBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_lead")
	public static final Block block = null;

	public BlockOfLeadBlock(TmimModElements instance) {
		super(instance, 175);
	}
