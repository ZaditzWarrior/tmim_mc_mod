...
public class AmethystOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:amethyst_ore")
	public static final Block block = null;

	public AmethystOreBlock(TmimModElements instance) {
		super(instance, 134);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AmethystShardItem.block, (int) (2)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:amethyst_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:amethyst_ore"), configuredFeature);
		}
	}
