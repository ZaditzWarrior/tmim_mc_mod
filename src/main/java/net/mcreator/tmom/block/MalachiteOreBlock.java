...
import net.mcreator.tmom.item.MalachiteItem;
...
public class MalachiteOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:malachite_ore")
	public static final Block block = null;

	public MalachiteOreBlock(TmimModElements instance) {
		super(instance, 212);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:malachite_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:malachite_ore"), configuredFeature);
		}
	}
