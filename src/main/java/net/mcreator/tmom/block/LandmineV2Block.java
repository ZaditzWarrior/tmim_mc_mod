...
import net.mcreator.tmom.procedures.Explode_x8Procedure;
...
public class LandmineV2Block extends TmimModElements.ModElement {
	@ObjectHolder("tmim:landmine_v_2")
	public static final Block block = null;

	public LandmineV2Block(TmimModElements instance) {
		super(instance, 657);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Explode_x8Procedure.executeProcedure(Stream
