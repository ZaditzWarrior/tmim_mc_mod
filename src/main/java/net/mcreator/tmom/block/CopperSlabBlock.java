...
public class CopperSlabBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:copper_slab")
	public static final Block block = null;

	public CopperSlabBlock(TmimModElements instance) {
		super(instance, 492);
	}
