...
public class CopperWallBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:copper_wall")
	public static final Block block = null;

	public CopperWallBlock(TmimModElements instance) {
		super(instance, 524);
	}
	...
	public static class CustomBlock extends WallBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A wall made from_copper"));
		}
