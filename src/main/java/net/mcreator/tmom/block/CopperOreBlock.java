...
public class CopperOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:copper_ore")
	public static final Block block = null;

	public CopperOreBlock(TmimModElements instance) {
		super(instance, 1);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:copper_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:copper_ore"), configuredFeature);
		}
	}
