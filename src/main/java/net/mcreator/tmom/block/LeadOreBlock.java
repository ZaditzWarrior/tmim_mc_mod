...
public class LeadOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:lead_ore")
	public static final Block block = null;

	public LeadOreBlock(TmimModElements instance) {
		super(instance, 172);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:lead_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:lead_ore"), configuredFeature);
		}
	}
