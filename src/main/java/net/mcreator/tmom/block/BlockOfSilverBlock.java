...
public class BlockOfSilverBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_silver")
	public static final Block block = null;

	public BlockOfSilverBlock(TmimModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_silver");
		}
