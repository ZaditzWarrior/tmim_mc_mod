...
public class BlockOfAluminumBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_aluminum")
	public static final Block block = null;

	public BlockOfAluminumBlock(TmimModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_aluminum");
		}
