...
public class BlockOfSarconiumBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_sarconium")
	public static final Block block = null;

	public BlockOfSarconiumBlock(TmimModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_sarconium");
		}
