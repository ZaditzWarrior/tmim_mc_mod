...
public class BlockOfCobaltBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_cobalt")
	public static final Block block = null;

	public BlockOfCobaltBlock(TmimModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_cobalt");
		}
