...
public class BlueCrystalPlantBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:blue_crystal_plant")
	public static final Block block = null;

	public BlueCrystalPlantBlock(TmimModElements instance) {
		super(instance, 312);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blue_crystal_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:blue_crystal_plant"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("blue_crystal_plant");
		}
