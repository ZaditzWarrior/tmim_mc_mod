...
public class DarkEnergonOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:dark_energon_ore")
	public static final Block block = null;

	public DarkEnergonOreBlock(TmimModElements instance) {
		super(instance, 84);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_energon_ore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(DarkEnergonShardItem.block));
		}
	}
}
