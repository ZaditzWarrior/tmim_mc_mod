...
public class CobaltSlabBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:cobalt_slab")
	public static final Block block = null;

	public CobaltSlabBlock(TmimModElements instance) {
		super(instance, 494);
	}
