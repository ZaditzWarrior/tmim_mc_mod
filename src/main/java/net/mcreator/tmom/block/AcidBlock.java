...
import net.mcreator.tmom.procedures.Break_BlockProcedure;
...
public class AcidBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:acid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("tmim:acid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public AcidBlock(TmimModElements instance) {
		super(instance, 161);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("tmim:blocks/acid_fluid"), new ResourceLocation("tmim:blocks/acid_fluid")).luminosity(0)
						.density(1000).viscosity(300).temperature(300)
		...
		elements.blocks
				.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.WATER).hardnessAndResistance(100f).setLightLevel(s -> 0)) {
					public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos,
							boolean moving) {
						...
						Break_BlockProcedure.executeProcedure(Stream
					...
					public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
						...
						RadiationDamageProcedure.executeProcedure(
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:acid_lakes"), configuredFeature);
		}
	}
