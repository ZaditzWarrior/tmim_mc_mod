...
public class BlockOfMagnesiumBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_magnesium")
	public static final Block block = null;

	public BlockOfMagnesiumBlock(TmimModElements instance) {
		super(instance, 256);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_magnesium");
		}
