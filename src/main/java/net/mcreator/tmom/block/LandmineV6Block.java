...
import net.mcreator.tmom.procedures.Explosion_X500Procedure;
...
public class LandmineV6Block extends TmimModElements.ModElement {
	@ObjectHolder("tmim:landmine_v_6")
	public static final Block block = null;

	public LandmineV6Block(TmimModElements instance) {
		super(instance, 669);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Explodes when stepped on [Requires more than 4GB RAM]"));
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Explosion_X500Procedure.executeProcedure(Stream
