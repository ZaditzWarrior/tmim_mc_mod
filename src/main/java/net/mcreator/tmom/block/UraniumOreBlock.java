...
public class UraniumOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:uranium_ore")
	public static final Block block = null;

	public UraniumOreBlock(TmimModElements instance) {
		super(instance, 163);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:uranium_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:uranium_ore"), configuredFeature);
		}
	}
