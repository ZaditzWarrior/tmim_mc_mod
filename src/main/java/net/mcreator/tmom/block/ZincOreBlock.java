...
public class ZincOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:zinc_ore")
	public static final Block block = null;

	public ZincOreBlock(TmimModElements instance) {
		super(instance, 177);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:zinc_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:zinc_ore"), configuredFeature);
		}
	}
