...
public class RubyPlatingBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:ruby_plating")
	public static final Block block = null;

	public RubyPlatingBlock(TmimModElements instance) {
		super(instance, 398);
	}
