...
import net.mcreator.tmom.item.ObsidianCrystalItem;
...
public class ObsidianOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:obsidian_ore")
	public static final Block block = null;

	public ObsidianOreBlock(TmimModElements instance) {
		super(instance, 192);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(ObsidianCrystalItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:obsidian_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:obsidian_ore"), configuredFeature);
		}
	}
