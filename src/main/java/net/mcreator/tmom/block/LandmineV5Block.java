...
import net.mcreator.tmom.procedures.Explosion_X100Procedure;
...
public class LandmineV5Block extends TmimModElements.ModElement {
	@ObjectHolder("tmim:landmine_v_5")
	public static final Block block = null;

	public LandmineV5Block(TmimModElements instance) {
		super(instance, 666);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			Explosion_X100Procedure.executeProcedure(Stream
