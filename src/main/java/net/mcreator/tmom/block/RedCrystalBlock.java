...
import net.mcreator.tmom.procedures.MineexplodeProcedure;
import net.mcreator.tmom.itemgroup.ModBlocksItemGroup;
import net.mcreator.tmom.item.RedCrystalShardItem;
...
public class RedCrystalBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:red_crystal")
	public static final Block block = null;

	public RedCrystalBlock(TmimModElements instance) {
		super(instance, 87);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:red_crystal"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.GLASS)
					.hardnessAndResistance(1.5f, 0f).setLightLevel(s -> 0));
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This crystal has a 40% Chance of exploding when mined"));
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RedCrystalShardItem.block, (int) (2)));
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			MineexplodeProcedure.executeProcedure(Stream
