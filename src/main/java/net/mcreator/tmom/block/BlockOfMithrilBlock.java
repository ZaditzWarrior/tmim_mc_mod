...
public class BlockOfMithrilBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_of_mithril")
	public static final Block block = null;

	public BlockOfMithrilBlock(TmimModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("block_of_mithril");
		}
