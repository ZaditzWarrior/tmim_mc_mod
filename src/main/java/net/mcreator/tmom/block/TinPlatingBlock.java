...
public class TinPlatingBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:tin_plating")
	public static final Block block = null;

	public TinPlatingBlock(TmimModElements instance) {
		super(instance, 269);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(1f, 35f).setLightLevel(s -> 0));
			setRegistryName("tin_plating");
		}
