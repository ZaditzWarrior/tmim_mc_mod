...
public class RedRupeeplantBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:red_rupeeplant")
	public static final Block block = null;

	public RedRupeeplantBlock(TmimModElements instance) {
		super(instance, 320);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("red_rupeeplant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:red_rupeeplant"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		public BlockCustomFlower() {
			super(Block.Properties.create(Material.PLANTS).tickRandomly().doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
					.setLightLevel(s -> 0));
			setRegistryName("red_rupeeplant");
		}
