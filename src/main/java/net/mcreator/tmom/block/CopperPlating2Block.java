...
public class CopperPlating2Block extends TmimModElements.ModElement {
	@ObjectHolder("tmim:copper_plating_2")
	public static final Block block = null;

	public CopperPlating2Block(TmimModElements instance) {
		super(instance, 373);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("copper_plating_2");
		}
