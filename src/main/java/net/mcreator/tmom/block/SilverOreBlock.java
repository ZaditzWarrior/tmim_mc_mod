...
public class SilverOreBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:silver_ore")
	public static final Block block = null;

	public SilverOreBlock(TmimModElements instance) {
		super(instance, 72);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("tmim:silver_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tmim:silver_ore"), configuredFeature);
		}
	}
