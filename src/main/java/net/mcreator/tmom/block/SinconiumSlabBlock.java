...
public class SinconiumSlabBlock extends TmimModElements.ModElement {
	@ObjectHolder("tmim:sinconium_slab")
	public static final Block block = null;

	public SinconiumSlabBlock(TmimModElements instance) {
		super(instance, 514);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("sinconium_slab");
		}
