...
import net.mcreator.tmom.item.TestItem;
import net.mcreator.tmom.block.GoldCoinOreBlock;
...
public class TestDimension extends TmimModElements.ModElement {
	@ObjectHolder("tmim:test_portal")
	public static final CustomPortalBlock portal = null;

	public TestDimension(TmimModElements instance) {
		super(instance, 130);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(GoldCoinOreBlock.block);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("tmim:test"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("test_portal", Vector3i::compareTo, 300);
	...
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("test_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("test_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new TestItem().setRegistryName("test"));
	}
	...
	public static class CustomPortalBlock extends NetherPortalBlock {
		...
		public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				...
				} else if (entity.world.getDimensionKey() != RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("tmim:test"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("tmim:test")));
				} else {
					entity.func_242279_ag();
