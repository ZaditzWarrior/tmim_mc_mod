...
public class AluminumContainerGUIGui extends TmimModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public AluminumContainerGUIGui(TmimModElements instance) {
		super(instance, 426);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("aluminum_container_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, AluminumContainerGUIGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(16, this.addSlot(new SlotItemHandler(internal, 16, 151, 44) {
			}));
			...
			this.customSlots.put(22, this.addSlot(new SlotItemHandler(internal, 22, 43, 8) {
			}));
			this.customSlots.put(23, this.addSlot(new SlotItemHandler(internal, 23, 115, 44) {
			}));
			this.customSlots.put(24, this.addSlot(new SlotItemHandler(internal, 24, 79, 26) {
			}));
			this.customSlots.put(25, this.addSlot(new SlotItemHandler(internal, 25, 133, 44) {
			}));
			this.customSlots.put(26, this.addSlot(new SlotItemHandler(internal, 26, 115, 26) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
