...
public class DarkCrystalconverterGUIGui extends TmimModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public DarkCrystalconverterGUIGui(TmimModElements instance) {
		super(instance, 616);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("dark_crystalconverter_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, DarkCrystalconverterGUIGuiWindow::new));
	}
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 25, 26) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (DarkEnergonShardItem.block == stack.getItem());
				}
			}));
			...
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 25, 53) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (BatteryItem.block == stack.getItem());
				}
			}));
			int si;
			int sj;
