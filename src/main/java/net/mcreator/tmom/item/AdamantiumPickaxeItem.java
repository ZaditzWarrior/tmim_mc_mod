...
public class AdamantiumPickaxeItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:adamantium_pickaxe")
	public static final Item block = null;

	public AdamantiumPickaxeItem(TmimModElements instance) {
		super(instance, 108);
	}
