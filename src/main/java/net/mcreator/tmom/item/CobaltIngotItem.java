...
public class CobaltIngotItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:cobalt_ingot")
	public static final Item block = null;

	public CobaltIngotItem(TmimModElements instance) {
		super(instance, 14);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A dark blue metal with conductive properties"));
		}
	}
}
