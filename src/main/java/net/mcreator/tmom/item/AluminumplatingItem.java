...
public class AluminumplatingItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:aluminumplating")
	public static final Item block = null;

	public AluminumplatingItem(TmimModElements instance) {
		super(instance, 367);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("aluminumplating");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Plate Made from Aluminum"));
		}
	}
}
