...
import net.mcreator.tmom.procedures.ReplacecopperProcedure;
...
public class BlockreplacerV8Item extends TmimModElements.ModElement {
	@ObjectHolder("tmim:blockreplacer_v_8")
	public static final Item block = null;

	public BlockreplacerV8Item(TmimModElements instance) {
		super(instance, 649);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blockreplacer_v_8");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			ReplacecopperProcedure.executeProcedure(Stream
