...
public class SilverIngotItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:silver_ingot")
	public static final Item block = null;

	public SilverIngotItem(TmimModElements instance) {
		super(instance, 73);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A shiny metal that is used to make coins"));
		}
	}
}
