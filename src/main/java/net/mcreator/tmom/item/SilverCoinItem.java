...
public class SilverCoinItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:silver_coin")
	public static final Item block = null;

	public SilverCoinItem(TmimModElements instance) {
		super(instance, 93);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A coin made from silver"));
			list.add(new StringTextComponent("Can be used for roll play"));
		}
	}
}
