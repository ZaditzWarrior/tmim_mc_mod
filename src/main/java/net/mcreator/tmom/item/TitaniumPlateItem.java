...
public class TitaniumPlateItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:titanium_plate")
	public static final Item block = null;

	public TitaniumPlateItem(TmimModElements instance) {
		super(instance, 408);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A plate made from titanium"));
		}
	}
}
