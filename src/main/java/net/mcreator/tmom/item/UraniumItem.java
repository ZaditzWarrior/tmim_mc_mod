...
public class UraniumItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:uranium")
	public static final Item block = null;

	public UraniumItem(TmimModElements instance) {
		super(instance, 164);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A radioactive element that ionizes anything it is near"));
		}
