...
public class TinPlating2Item extends TmimModElements.ModElement {
	@ObjectHolder("tmim:tin_plating_2")
	public static final Item block = null;

	public TinPlating2Item(TmimModElements instance) {
		super(instance, 270);
	}
