...
public class RedDiamondSwordItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:red_diamond_sword")
	public static final Item block = null;

	public RedDiamondSwordItem(TmimModElements instance) {
		super(instance, 282);
	}
