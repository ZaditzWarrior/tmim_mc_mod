...
public class BlueRupeeItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:blue_rupee")
	public static final Item block = null;

	public BlueRupeeItem(TmimModElements instance) {
		super(instance, 292);
	}
