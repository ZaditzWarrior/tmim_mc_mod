...
public class ElectroniccircuitItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:electroniccircuit")
	public static final Item block = null;

	public ElectroniccircuitItem(TmimModElements instance) {
		super(instance, 381);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("electroniccircuit");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Simple Circuit"));
		}
	}
}
