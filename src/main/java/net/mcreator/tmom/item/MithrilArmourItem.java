...
public class MithrilArmourItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:mithril_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("tmim:mithril_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("tmim:mithril_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("tmim:mithril_armour_boots")
	public static final Item boots = null;

	public MithrilArmourItem(TmimModElements instance) {
		super(instance, 67);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ArmourandToolsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "tmim:textures/models/armor/mithril_armour_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("mithril_armour_helmet"));
		...
		}.setRegistryName("mithril_armour_chestplate"));
		...
		}.setRegistryName("mithril_armour_leggings"));
		...
		}.setRegistryName("mithril_armour_boots"));
	}
