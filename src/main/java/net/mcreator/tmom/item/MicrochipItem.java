...
public class MicrochipItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:microchip")
	public static final Item block = null;

	public MicrochipItem(TmimModElements instance) {
		super(instance, 366);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Flexable Unit with many functions"));
		}
	}
}
