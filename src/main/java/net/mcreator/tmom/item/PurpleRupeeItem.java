...
public class PurpleRupeeItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:purple_rupee")
	public static final Item block = null;

	public PurpleRupeeItem(TmimModElements instance) {
		super(instance, 296);
	}
