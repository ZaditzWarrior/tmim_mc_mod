...
public class VibraniumArmourItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:vibranium_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("tmim:vibranium_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("tmim:vibranium_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("tmim:vibranium_armour_boots")
	public static final Item boots = null;

	public VibraniumArmourItem(TmimModElements instance) {
		super(instance, 124);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ArmourandToolsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "tmim:textures/models/armor/vibranium_armour_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("vibranium_armour_helmet"));
		...
		}.setRegistryName("vibranium_armour_chestplate"));
		...
		}.setRegistryName("vibranium_armour_leggings"));
		...
		}.setRegistryName("vibranium_armour_boots"));
	}
