...
public class GlassPlateItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:glass_plate")
	public static final Item block = null;

	public GlassPlateItem(TmimModElements instance) {
		super(instance, 476);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("a plate made from glass"));
		}
	}
}
