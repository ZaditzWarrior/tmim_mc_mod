...
public class GlassshardItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:glassshard")
	public static final Item block = null;

	public GlassshardItem(TmimModElements instance) {
		super(instance, 474);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A shard of glass"));
			list.add(new StringTextComponent("Careful!"));
		}
	}
}
