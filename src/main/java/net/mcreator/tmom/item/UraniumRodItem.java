...
public class UraniumRodItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:uranium_rod")
	public static final Item block = null;

	public UraniumRodItem(TmimModElements instance) {
		super(instance, 168);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A rod made from uranium"));
		}
