...
import net.mcreator.tmom.procedures.ReplaceblockcoalProcedure;
...
public class BlockReplacerV2Item extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_replacer_v_2")
	public static final Item block = null;

	public BlockReplacerV2Item(TmimModElements instance) {
		super(instance, 623);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("block_replacer_v_2");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			ReplaceblockcoalProcedure.executeProcedure(Stream
