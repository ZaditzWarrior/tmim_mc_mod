...
public class LeadIngotItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:lead_ingot")
	public static final Item block = null;

	public LeadIngotItem(TmimModElements instance) {
		super(instance, 173);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A strong but heavy metal"));
		}
	}
}
