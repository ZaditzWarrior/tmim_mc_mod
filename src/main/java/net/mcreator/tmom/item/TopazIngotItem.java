...
public class TopazIngotItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:topaz_ingot")
	public static final Item block = null;

	public TopazIngotItem(TmimModElements instance) {
		super(instance, 149);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The ingot form of Topaz"));
		}
	}
}
