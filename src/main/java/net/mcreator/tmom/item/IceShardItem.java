...
public class IceShardItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:ice_shard")
	public static final Item block = null;

	public IceShardItem(TmimModElements instance) {
		super(instance, 534);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A shard of Ice"));
			list.add(new StringTextComponent("Very Cold"));
		}
	}
}
