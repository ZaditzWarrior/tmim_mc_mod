...
public class PistolAmmoItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:pistol_ammo")
	public static final Item block = null;

	public PistolAmmoItem(TmimModElements instance) {
		super(instance, 559);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Bullets for the pistol"));
		}
	}
}
