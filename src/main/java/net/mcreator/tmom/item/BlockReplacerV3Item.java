...
import net.mcreator.tmom.procedures.ReplaceblockironProcedure;
...
public class BlockReplacerV3Item extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_replacer_v_3")
	public static final Item block = null;

	public BlockReplacerV3Item(TmimModElements instance) {
		super(instance, 634);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("block_replacer_v_3");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			ReplaceblockironProcedure.executeProcedure(Stream
