...
public class RifleAmmoItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:rifle_ammo")
	public static final Item block = null;

	public RifleAmmoItem(TmimModElements instance) {
		super(instance, 547);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Ammo for rifles"));
		}
	}
}
