...
public class AdamantiumArmourItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:adamantium_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("tmim:adamantium_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("tmim:adamantium_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("tmim:adamantium_armour_boots")
	public static final Item boots = null;

	public AdamantiumArmourItem(TmimModElements instance) {
		super(instance, 114);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{10, 6, 8, 5}[slot.getIndex()];
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ArmourandToolsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "tmim:textures/models/armor/adamantium_armour_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("adamantium_armour_helmet"));
		...
		}.setRegistryName("adamantium_armour_chestplate"));
		...
		}.setRegistryName("adamantium_armour_leggings"));
		...
		}.setRegistryName("adamantium_armour_boots"));
	}
