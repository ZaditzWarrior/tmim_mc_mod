...
public class StonePlateItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:stone_plate")
	public static final Item block = null;

	public StonePlateItem(TmimModElements instance) {
		super(instance, 469);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A plate made from stone"));
		}
	}
}
