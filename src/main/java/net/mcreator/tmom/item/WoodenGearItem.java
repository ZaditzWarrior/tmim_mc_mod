...
public class WoodenGearItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:wooden_gear")
	public static final Item block = null;

	public WoodenGearItem(TmimModElements instance) {
		super(instance, 416);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A gear made from wood"));
		}
	}
}
