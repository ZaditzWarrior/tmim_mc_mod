...
public class RubyArmourItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:ruby_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("tmim:ruby_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("tmim:ruby_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("tmim:ruby_armour_boots")
	public static final Item boots = null;

	public RubyArmourItem(TmimModElements instance) {
		super(instance, 53);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public int getDamageReductionAmount(EquipmentSlotType slot) {
				return new int[]{9, 9, 9, 9}[slot.getIndex()];
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ArmourandToolsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "tmim:textures/models/armor/ruby_armour_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
