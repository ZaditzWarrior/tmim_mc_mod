...
public class SarconiumArmourItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:sarconium_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("tmim:sarconium_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("tmim:sarconium_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("tmim:sarconium_armour_boots")
	public static final Item boots = null;

	public SarconiumArmourItem(TmimModElements instance) {
		super(instance, 35);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ArmourandToolsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "tmim:textures/models/armor/sarconium_armour_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("sarconium_armour_helmet"));
		...
		}.setRegistryName("sarconium_armour_chestplate"));
		...
		}.setRegistryName("sarconium_armour_leggings"));
		...
		}.setRegistryName("sarconium_armour_boots"));
	}
