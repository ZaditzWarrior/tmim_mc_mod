...
public class IronGearItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:iron_gear")
	public static final Item block = null;

	public IronGearItem(TmimModElements instance) {
		super(instance, 420);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A Gear Made from Iron"));
		}
	}
}
