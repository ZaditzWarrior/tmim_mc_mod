...
public class GunMechanismItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:gun_mechanism")
	public static final Item block = null;

	public GunMechanismItem(TmimModElements instance) {
		super(instance, 552);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A mechanism used in a gun"));
		}
	}
}
