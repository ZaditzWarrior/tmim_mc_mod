...
public class ZincIngotItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:zinc_ingot")
	public static final Item block = null;

	public ZincIngotItem(TmimModElements instance) {
		super(instance, 178);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A weak metal that is used to make batteries"));
		}
	}
}
