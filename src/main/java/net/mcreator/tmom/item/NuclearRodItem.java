...
public class NuclearRodItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:nuclear_rod")
	public static final Item block = null;

	public NuclearRodItem(TmimModElements instance) {
		super(instance, 244);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A rod uses in nuclear powerplants"));
		}
