...
public class CobaltplateItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:cobaltplate")
	public static final Item block = null;

	public CobaltplateItem(TmimModElements instance) {
		super(instance, 375);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A Plate Made From Cobalt"));
		}
	}
}
