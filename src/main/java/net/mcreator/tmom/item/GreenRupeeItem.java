...
public class GreenRupeeItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:green_rupee")
	public static final Item block = null;

	public GreenRupeeItem(TmimModElements instance) {
		super(instance, 298);
	}
