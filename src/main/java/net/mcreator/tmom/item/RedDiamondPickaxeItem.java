...
public class RedDiamondPickaxeItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:red_diamond_pickaxe")
	public static final Item block = null;

	public RedDiamondPickaxeItem(TmimModElements instance) {
		super(instance, 280);
	}
