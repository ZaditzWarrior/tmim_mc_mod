...
public class AluminumIngotItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:aluminum_ingot")
	public static final Item block = null;

	public AluminumIngotItem(TmimModElements instance) {
		super(instance, 139);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A relativly weak metal that is not conductive"));
		}
	}
}
