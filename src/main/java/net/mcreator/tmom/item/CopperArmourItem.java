...
public class CopperArmourItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:copper_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("tmim:copper_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("tmim:copper_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("tmim:copper_armour_boots")
	public static final Item boots = null;

	public CopperArmourItem(TmimModElements instance) {
		super(instance, 4);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ArmourandToolsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "tmim:textures/models/armor/copper_armour_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("copper_armour_helmet"));
		...
		}.setRegistryName("copper_armour_chestplate"));
		...
		}.setRegistryName("copper_armour_leggings"));
		...
		}.setRegistryName("copper_armour_boots"));
	}
