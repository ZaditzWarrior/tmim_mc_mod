...
public class SinconiumIngotItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:sinconium_ingot")
	public static final Item block = null;

	public SinconiumIngotItem(TmimModElements instance) {
		super(instance, 286);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sinconium_ingot");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A stupidly strong metal"));
		}
	}
}
