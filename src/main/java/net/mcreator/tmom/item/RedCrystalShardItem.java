...
public class RedCrystalShardItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:red_crystal_shard")
	public static final Item block = null;

	public RedCrystalShardItem(TmimModElements instance) {
		super(instance, 653);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A shard of pure red crystal"));
		}
	}
}
