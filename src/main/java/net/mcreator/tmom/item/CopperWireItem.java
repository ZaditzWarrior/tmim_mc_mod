...
public class CopperWireItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:copper_wire")
	public static final Item block = null;

	public CopperWireItem(TmimModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Highly conductive wire used in electronics"));
		}
	}
}
