...
public class TinIngotItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:tin_ingot")
	public static final Item block = null;

	public TinIngotItem(TmimModElements instance) {
		super(instance, 145);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A weak metal"));
		}
	}
}
