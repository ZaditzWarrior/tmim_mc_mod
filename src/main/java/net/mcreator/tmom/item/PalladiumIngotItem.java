...
public class PalladiumIngotItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:palladium_ingot")
	public static final Item block = null;

	public PalladiumIngotItem(TmimModElements instance) {
		super(instance, 158);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A metal that is alway hot"));
		}
	}
}
