...
public class MithrilIngotItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:mithril_ingot")
	public static final Item block = null;

	public MithrilIngotItem(TmimModElements instance) {
		super(instance, 61);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A Mythical material"));
			list.add(new StringTextComponent("Unknown properties"));
		}
	}
}
