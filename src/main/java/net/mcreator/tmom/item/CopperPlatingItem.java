...
public class CopperPlatingItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:copper_plating")
	public static final Item block = null;

	public CopperPlatingItem(TmimModElements instance) {
		super(instance, 371);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("copper_plating");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A Plate Made From Copper"));
		}
	}
}
