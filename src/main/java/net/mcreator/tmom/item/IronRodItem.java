...
public class IronRodItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:iron_rod")
	public static final Item block = null;

	public IronRodItem(TmimModElements instance) {
		super(instance, 199);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A rod made from iron"));
		}
	}
}
