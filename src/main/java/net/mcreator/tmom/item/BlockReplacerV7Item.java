...
import net.mcreator.tmom.procedures.ReplaceoakwoodProcedure;
...
public class BlockReplacerV7Item extends TmimModElements.ModElement {
	@ObjectHolder("tmim:block_replacer_v_7")
	public static final Item block = null;

	public BlockReplacerV7Item(TmimModElements instance) {
		super(instance, 646);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("block_replacer_v_7");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			ReplaceoakwoodProcedure.executeProcedure(Stream
