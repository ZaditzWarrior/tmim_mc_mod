...
public class GrenadeitemItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:grenadeitem")
	public static final Item block = null;

	public GrenadeitemItem(TmimModElements instance) {
		super(instance, 582);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Item is not obtainable in survival"));
		}
	}
}
