...
public class StoneGearItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:stone_gear")
	public static final Item block = null;

	public StoneGearItem(TmimModElements instance) {
		super(instance, 418);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A Gear Made From Stone"));
		}
	}
}
