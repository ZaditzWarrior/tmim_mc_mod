...
public class CircuitBoardItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:circuit_board")
	public static final Item block = null;

	public CircuitBoardItem(TmimModElements instance) {
		super(instance, 379);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("An Empty Board With Space To Install Components"));
		}
	}
}
