...
public class GunBarrelItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:gun_barrel")
	public static final Item block = null;

	public GunBarrelItem(TmimModElements instance) {
		super(instance, 544);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used in guns"));
		}
	}
}
