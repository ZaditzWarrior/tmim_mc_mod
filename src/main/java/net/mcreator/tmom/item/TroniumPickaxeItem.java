...
public class TroniumPickaxeItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:tronium_pickaxe")
	public static final Item block = null;

	public TroniumPickaxeItem(TmimModElements instance) {
		super(instance, 632);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("tronium_pickaxe"));
	}
}
