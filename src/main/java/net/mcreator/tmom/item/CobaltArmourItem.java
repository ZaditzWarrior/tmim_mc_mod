...
public class CobaltArmourItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:cobalt_armour_helmet")
	public static final Item helmet = null;
	@ObjectHolder("tmim:cobalt_armour_chestplate")
	public static final Item body = null;
	@ObjectHolder("tmim:cobalt_armour_leggings")
	public static final Item legs = null;
	@ObjectHolder("tmim:cobalt_armour_boots")
	public static final Item boots = null;

	public CobaltArmourItem(TmimModElements instance) {
		super(instance, 22);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ArmourandToolsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "tmim:textures/models/armor/cobalt_armour_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("cobalt_armour_helmet"));
		...
		}.setRegistryName("cobalt_armour_chestplate"));
		...
		}.setRegistryName("cobalt_armour_leggings"));
		...
		}.setRegistryName("cobalt_armour_boots"));
	}
