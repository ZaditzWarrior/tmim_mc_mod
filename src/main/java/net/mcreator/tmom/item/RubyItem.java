...
public class RubyItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:ruby")
	public static final Item block = null;

	public RubyItem(TmimModElements instance) {
		super(instance, 52);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A red gem that looks similar to diamond"));
		}
	}
}
