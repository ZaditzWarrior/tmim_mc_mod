...
public class ScrewItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:screw")
	public static final Item block = null;

	public ScrewItem(TmimModElements instance) {
		super(instance, 580);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Can hold things together"));
		}
	}
}
