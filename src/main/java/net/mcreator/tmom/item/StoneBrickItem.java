...
public class StoneBrickItem extends TmimModElements.ModElement {
	@ObjectHolder("tmim:stone_brick")
	public static final Item block = null;

	public StoneBrickItem(TmimModElements instance) {
		super(instance, 467);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A brick made from stone"));
		}
	}
}
