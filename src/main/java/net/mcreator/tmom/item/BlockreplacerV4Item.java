...
import net.mcreator.tmom.procedures.ReplaceblockgoldProcedure;
...
public class BlockreplacerV4Item extends TmimModElements.ModElement {
	@ObjectHolder("tmim:blockreplacer_v_4")
	public static final Item block = null;

	public BlockreplacerV4Item(TmimModElements instance) {
		super(instance, 637);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blockreplacer_v_4");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			ReplaceblockgoldProcedure.executeProcedure(Stream
