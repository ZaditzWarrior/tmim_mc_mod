...
import net.mcreator.tmom.entity.renderer.DiamondGolemRenderer;
import net.mcreator.tmom.TmimModElements;

@TmimModElements.ModElement.Tag
public class DiamondGolemEntity extends TmimModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("diamond_golem").setRegistryName("diamond_golem");

	public DiamondGolemEntity(TmimModElements instance) {
		super(instance, 324);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DiamondGolemRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711681, -16737895, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("diamond_golem_spawn_egg"));
	}
